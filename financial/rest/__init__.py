...
# local imports
from . import purse, users, wallets, comments, currency
...
def create_api(application):
    ...
    # for currency
    api.add_resource(currency.AllCurrencies, "/api/currency")
    api.add_resource(currency.SingleCurrency, "/api/currency/<identifier>")
    # for wallets
